...
// Memoized stats calculator for performance
const useInventoryStats = (products: Product[]) => {
  return useMemo(() => ({
...
// Memoized alert items for performance
const useAlertItems = (products: Product[]) => {
  return useMemo(() => products.filter(p => {
...
export default function Index() {
  ...
  const alertItems = useAlertItems(products);
    ...
    <Layout>
      <PullToRefresh onRefresh={handleRefresh}>
        <div className="space-y-6">
          ...
          {/* Quick Actions */}
          {!isLoading && <DashboardQuickActions />}
